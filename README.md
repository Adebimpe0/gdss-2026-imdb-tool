...
Extract — Gemini Vision analyzes the image and returns structured JSON with 13 fields
Validate — Barcodes, weights, packaging types, and country names are normalized
Gap-Fill — Missing fields are cross-referenced across multiple images of the same product
Preview — User reviews and edits extracted data
Export — Clean CSV/Excel file ready for database import
How to Run Locally
...
Create a .env file: GEMINI_API_KEY=your_api_key_here Run the app:
